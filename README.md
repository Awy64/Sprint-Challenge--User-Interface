...
It is used so that you elements have meaning and other people can understand your code behind you.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

display block will use a new line where inline will not bump you to a new line.
...
git allows you to colab with other coders easier, verison control, undo changes, keep you from having to save old copys of your code, easy to distrubite.
